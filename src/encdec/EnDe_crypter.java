...
public class EnDe_crypter {
	...
	public static void main(String args[]) throws Exception {
		// byte[] b = encd.iv;
		// encd = new EnDe_crypter("anything", "256");
		// encd.encrypt("mypassword");
		// System.out.println(encd.decrypt(enc_data, b));

		// EnDe_crypter decrypter = new EnDe_crypter("1");
		// String encrypted = decrypter.encrypt("the quick brown fox jumps over the lazy
		// dog");
